...
private let sportsCellId = "cellId"
...
class SportsController: UIViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(TopHeadlinesViewCell.self, forCellWithReuseIdentifier: sportsCellId)
    ...
    override func viewDidLoad() {
        ...
        topHeadlineViewModel.fetchData(country: "us", category: "sports")
...
extension SportsController: UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: sportsCellId, for: indexPath) as! TopHeadlinesViewCell
...
extension SportsController: TopHeadlineViewModelDelegate {
    func updateTopHeadlineData() {
        collectionView.reloadData()
    }
}

extension SportsController: TopHeadlineControllerDelegate {
    func updateData() {
        topHeadlineViewModel.fetchData(country: "us", category: "sports")
    }
}
